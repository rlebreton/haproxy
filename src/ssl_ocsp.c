...
/*
 * Set the OCSP status in the optional 'status_var' variable specified by the
 * user, and the error reason (if any) in the optional 'reason_var' variable.
 * Returns 0 in case of success, 1 otherwise.
 */
